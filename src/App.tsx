        ...
        <>
                        ...
                        <Routes>
                            ...
                            <Route element={<PrivateRoute />}>
                                <Route element={<AppLayout />}>
                                    ...
                                    <Route path="/localities/list" element={<LocalitiesListPage />} />
            ...
            <Route path="/entity" element={< AddEntity />} />
              <Route path="/entity/list" element={<EntityListPage />} />
                                    ...
                                    {/* Reporting Page */}
                                    <Route path="/reportings" element={<AddReportFormElements />} />


                                    <Route path="/reportings/list" element={<ReportsListPage />} />
