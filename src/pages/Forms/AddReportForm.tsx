  ...
  return (
    <>
      ...
      <div className="space-y-6 p-4">
        <ComponentCard title={t("reporting_form_title")}>
          <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            <div className="p-field">
              <label htmlFor="attachmentUrl" className="block mb-2 font-bold">
               {t('attachment_url')}
              </label>
              <Input
                id="attachmentUrl"
            ...
            <button
              type="submit"
              className="px-3 py-1 text-sm text-white bg-blue-900 rounded disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              disabled={
                loading ||
                !title.trim() ||
                !description.trim() ||
